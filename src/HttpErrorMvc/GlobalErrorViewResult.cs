namespace HttpErrorMvc
{
    ...
    /// </summary>
    public class GlobalErrorViewResult : HttpStatusCodeResult
    {
        public GlobalErrorViewResult(int statusCode)
            : base(statusCode)
        {
            this.ViewName = GlobalErrorConfig.CustomData.ErrorViewName;
        ...
        public override void ExecuteResult(ControllerContext context)
        {
            ...
            GlobalErrorConfig.OnErrorHandling(context.RequestContext.HttpContext.Request, new Uri(requestedUrl));
